...
userRouter.post('/register',
    ...
    body('password').trim().isAlphanumeric().isLength({ min: 6 }).withMessage('Password must be at least 6 characters long at may contain only English letters and numbers'),
